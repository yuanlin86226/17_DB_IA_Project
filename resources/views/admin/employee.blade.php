...
@php ($REST_API = '/api/admin/employee/')
                                ...
                                <form class="form-horizontal">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <p class="form-control-static">@{{row.job}}</p>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <p class="form-control-static">@{{row.identity_id}}</p>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <p class="form-control-static">@{{row.start_date}}</p>
                                            </div>
                                        </div>
                                    </fieldset>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <legend v-if="type==='update'">修改 員工</legend>
                                <legend v-if="type==='create'">新增 員工</legend>
                            </div>
                            <div class="content">
                                ...
                                <form method="POST" name="user_form" class="form-horizontal">
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">職稱</label>
                                            <div class="col-sm-10">
                                                <input :class="{'form-control': true, 'error': errors.has('job') }" type="text" name="job" placeholder="職稱" data-vv-as="職稱" v-model="row.job" v-validate="'required'">
                                                <span v-show="errors.has('job')" class="help-block">@{{ errors.first('job') }}</span>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">身分證字號</label>
                                            <div class="col-sm-10">
                                                <input :class="{'form-control': true, 'error': errors.has('identity_id') }" type="identity_id" name="identity_id" placeholder="身分證字號" data-vv-as="身分證字號" v-model="row.identity_id" v-validate="'required'">
                                                <span v-show="errors.has('identity_id')" class="help-block">@{{ errors.first('identity_id') }}</span>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">手機號碼</label>
                                            <div class="col-sm-10">
                                                <input :class="{'form-control': true, 'error': errors.has('cellphone') }" type="text" name="cellphone" placeholder="手機號碼" data-vv-as="手機號碼" v-model="row.cellphone" v-validate="'regex:^[0-9\.\-]+$'">
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">到職日</label>
                                            <div class="col-sm-10">
                                                <input :class="{'form-control': true, 'error': errors.has('start_date') }" type="date" name="start_date" placeholder="到職日" data-vv-as="到職日" v-model="row.start_date" v-validate="'required'">
                                                <span v-show="errors.has('start_date')" class="help-block">@{{ errors.first('start_date') }}</span>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                    ...
                                    <fieldset v-if="row.status==0">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <span v-show="errors.has('end_date')" class="help-block">@{{ errors.first('end_date') }}</span>
                                            </div>
                                        </div>
                                    </fieldset>
        ...
        methods: {
            ...
            save: function(e) {
                ...
                this.$validator.validateAll().then(function() {
                    ...
                    if (_this.row.start_date >= _this.row.end_date) {
                        swal({
                            title: "離職日期 錯誤",
                            type: "info"
                        });
