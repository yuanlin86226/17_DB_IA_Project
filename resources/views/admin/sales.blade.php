                                ...
                                <form class="form-horizontal">
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <p v-if="row.payment_method==0" class="form-control-static">現金</p>
                                                <p v-if="row.payment_method==1" class="form-control-static">信用卡</p>
                                            </div>
                                        </div>
                                    </fieldset>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <legend v-if="type==='update'">修改 出貨單</legend>
                                <legend v-if="type==='create'">新增 出貨單</legend>
                            </div>
                            <div class="content">
